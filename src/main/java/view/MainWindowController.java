	...
	private void handleLoadMap() {
		...
		if (mapFile != null) {
			try {
				...
				displayWarningMessageBox("Oups, il semble que le fichier que vous avez sp�cifi� ne soit pas une carte valide.");
	...
	private void handleLoadDelivery() {
		...
		if (deliveryRequestFile != null) {
			...
			try {
				...
				displayWarningMessageBox("Oups, il semble que le fichier que vous avez sp�cifi� ne soit pas une"
