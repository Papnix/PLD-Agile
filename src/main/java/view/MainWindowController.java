...
public class MainWindowController implements Initializable{
    ...
    private void handleLoadDelivery() {
    	...
    	if(deliveryRequestFile != null) {
        	...
        	canvasRound.widthProperty().addListener(evt -> graphBuilder.drawRound(canvasRound, round));
        	canvasRound.heightProperty().addListener(evt -> graphBuilder.drawRound(canvasRound, round));
    	}
    }
	...
	private void setupCanvasRound(Canvas canvas) {
